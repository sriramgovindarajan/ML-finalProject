...
```{r cache=TRUE}
library(caret)
set.seed(32223) # Set a seed for reproducibility
...
Training this model took about 30 minutes as compared to almost 1.5 hours for the initial model.
